...
DOWNLOAD_URL="https://github.com/$REPO/releases/download/$TAG/trello-$TARGET"

echo "Downloading trello $TAG for $TARGET..."
TMPFILE="$(mktemp)"
...
echo "trello $TAG installed successfully! Run 'trello --help' to get started."
